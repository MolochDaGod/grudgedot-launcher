...
const GAMES: GameEntry[] = [
  ...
  { id: "grudge-gangs", title: "Grudge Gangs", description: "Top-down MOBA with TVS knight keeps, ranger towers, wizard spires (D1/R2 CDN)", image: "/assets/games/scourge.png", route: "/moba", tags: ["MOBA", "TVS", "Top-down"], category: "games" },
  { id: "dcq-moba", title: "DCQ MOBA", description: "Full Grudge Warlords Voxel MOBA — 5v5, 3 lanes, TVS towers & heroes", image: "/assets/games/arena.jpg", route: "https://dungeon-crawler-quest.vercel.app/game", tags: ["MOBA", "DCQ", "External"], category: "games", external: true },
  { id: "dcq-full", title: "Dungeon Crawler Quest", description: "MOBA + Open World + DCQ + 3D Dungeon — TVS asset pipeline", image: "/assets/games/warlords.jpg", route: "https://dungeon-crawler-quest.vercel.app/", tags: ["DCQ", "MMO", "External"], category: "games", external: true },
  ...
  { id: "crypt-crawlers", title: "Crypt Crawlers", description: "DCQ top-down dungeon crawler — cathedral crypt floors themed from TVS packs (D1/R2)", image: "/assets/games/warlords.jpg", route: "/crypt-crawlers", tags: ["Roguelike", "DCQ", "TVS"], category: "games" },
