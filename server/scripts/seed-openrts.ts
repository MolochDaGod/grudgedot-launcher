...
async function main() {
  ...
  await sql.unsafe(`
    ...
    ('Knight', 'Knight', 'human', '3.5', 200, '7', 'Ground', '["Longsword"]', '{"gold":250}', 25, '0.25', '0.25', '1.0'),
    ('Priest', 'Priest', 'human', '2.2', 60, '8', 'Ground', '["HealingStaff"]', '{"gold":180}', 20, '0.25', '0.25', '1.0'),
    ('Crossbowman', 'Crossbowman', 'human', '2.3', 90, '10', 'Ground', '["Crossbow"]', '{"gold":150}', 16, '0.25', '0.25', '1.0'),
    ('Grunt', 'Grunt', 'alien', '2.3', 150, '5', 'Ground', '["WarHammer"]', '{"gold":110}', 10, '0.25', '0.25', '1.0'),
    ('Shaman', 'Shaman', 'alien', '2.0', 70, '8', 'Ground', '["LightningWand"]', '{"gold":200}', 22, '0.25', '0.25', '1.0'),
    ('Raider', 'Raider', 'alien', '4.0', 100, '7', 'Ground', '["Spear"]', '{"gold":160}', 18, '0.25', '0.25', '1.0'),
    ('Wyvern', 'Wyvern Rider', 'alien', '5.0', 180, '10', 'Fly', '["Spear"]', '{"gold":300}', 30, '0.25', '0.25', '1.0'),
    ('Skeleton', 'Skeleton Warrior', 'undead', '2.0', 80, '5', 'Ground', '["Longsword"]', '{"gold":60}', 8, '0.25', '0.25', '1.0'),
    ('SkeletonArcher', 'Skeleton Archer', 'undead', '2.2', 55, '9', 'Ground', '["ShortBow"]', '{"gold":75}', 10, '0.25', '0.25', '1.0'),
    ('Necromancer', 'Necromancer', 'undead', '1.8', 90, '8', 'Ground', '["Fireball"]', '{"gold":220}', 24, '0.25', '0.25', '1.0'),
    ('Ghost', 'Wraith', 'undead', '3.5', 60, '8', 'Fly', '["IceBolt"]', '{"gold":180}', 20, '0.25', '0.25', '1.0'),
    ('SiegeTank', 'Siege Tank', 'mechanical', '1.5', 400, '10', 'Ground', '["Fireball"]', '{"gold":350}', 35, '0.5', '0.5', '3.0'),
    ('ScoutDrone', 'Scout Drone', 'mechanical', '6.0', 40, '14', 'Fly', '[]', '{"gold":80}', 8, '0.25', '0.25', '1.0'),
    ('Treant', 'Treant', 'nature', '1.2', 350, '6', 'Ground', '["WarHammer"]', '{"gold":280}', 28, '0.6', '0.6', '2.5'),
    ('Fairy', 'Fairy Healer', 'nature', '3.5', 45, '9', 'Fly', '["HealingStaff"]', '{"gold":150}', 16, '0.25', '0.25', '1.0'),
    ('Wolf', 'Dire Wolf', 'nature', '5.5', 90, '8', 'Ground', '["Spear"]', '{"gold":120}', 12, '0.25', '0.25', '1.0')
  `);
